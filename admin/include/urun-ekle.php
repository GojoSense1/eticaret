      ...
      <a href="<?=SITE?>urun-liste" class="btn btn-info" style="float:right; margin-bottom:10px; margin-left:10px;"><i class="fas fa-bars"></i> LİSTE</a> 
       ...
       <div class="card-body card card-primary">
        ...
        <div class="col-md-12" style="margin-bottom: 20px;">
          <a class="btn btn-primary varyasyonEkleme" style="color:#fff; float: right;"><i class="fa fa-plus"></i> Varyasyon Ekle</a>
          <style type="text/css">
            .varyasyonGrup h2{background: #eee; border:1px solid #ddd; padding: 3px; font-size: 15px; display: block; overflow: hidden;}
            .varyasyonGrup .col-md-3{float: left;}
            .varyasyonGrup ul{display: block; list-style-type: none; padding: 3px; min-height: 100px; background: #fff; border: 1px solid #ddd;}
            .varyasyonGrup ul li{
              padding: 3px;
          ...
          <div class="row butonuKontrolEt" style="display:none; clear: both;">
              <a class="btn btn-warning" onclick="stokOlustur();" style="color: #fff;">Varyasyon Stoklarını Oluştur</a>
