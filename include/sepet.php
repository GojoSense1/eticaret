						...
						foreach ($_SESSION["sepetVaryasyon"][$urunbilgisi[0]["ID"]] as $secenekID => $secenekAdet) {
							...
							echo number_format($kdvsizBirimfiyat,2,",",".")." TL";
									...
									<td>
										<div class="numbers-row">
											<input type="text" value="<?=$secenekAdet["adet"]?>" id="adet" class="qty2 adet" name="adet[]">
							...
							else
							{
								...
								$sepetTutar=($sepetTutar+$kdvlifiyat);
									...
									<td class="options">
										<a href="<?=SITE?>sepet-sil/<?=$urunbilgisi[0]["ID"]?>/<?=$secenekID?>"><i class="ti-trash"></i></a>
									</td>
								</tr>
									<?php
							...
							echo number_format($kdvsizBirimfiyat,2,",",".")." TL";
									...
									<td>
										<div class="numbers-row">
											<input type="text" value="<?=$bilgi["adet"]?>" id="adet" class="qty2 adet" name="adet[]">
										<div class="inc button_inc">+</div><div class="dec button_inc">-</div></div>
									</td>
									<td>
										<strong>
		...
		<div class="box_cart">
			...
			<ul>
				...
				if($sepetkdvtutar6>0)
				{
					?>
					<li>
					<span>KDV Tutar (%6)</span> <?=number_format(($sepetkdvtutar6),2,",",".")?> TL
				</li>
					<?php
				}
				if($sepetkdvtutar8>0)
				...
				<li>
					<span>Ödenecek Tutar</span> <?=number_format(($sepetTutar),2,",",".")?> TL
				</li>
			</ul>
			<?php
