	...
	<!-- /page_header -->
			...
			<div class="col-xl-6 col-lg-6 col-md-8">
				<div class="box_account">
					...
					<div class="form_container">
						<div class="form-group">
							<input type="email" class="form-control" name="mail" id="email_2" placeholder="E-mail">
						</div>
						<div class="form-group">
							<input type="password" class="form-control" name="sifre" id="password_in_2" value="" placeholder="Parola">
						</div>
						<hr>
						<div class="form-group">
						...
						<div class="private box">
							...
							<div class="row no-gutters">
								<div class="col-6 pr-1">
									<div class="form-group">
										<input type="text" name="ilce" class="form-control" placeholder="İlçe">
									</div>
								</div>
								<div class="col-6 pl-1">
									<div class="form-group">
										<input type="text" name="postakodu" class="form-control" placeholder="Posta Kodu">
									</div>
								</div>
							</div>
							<!-- /row -->
						...
						<div class="company box" style="display: none;">
							<div class="row no-gutters">
								<div class="col-12">
									<div class="form-group">
										<input type="text" name="firmaadi" class="form-control" placeholder="Firma Adı*">
									</div>
								</div>
								<div class="col-6 pr-1">
									<div class="form-group">
										<input type="text" name="vergidairesi" class="form-control" placeholder="Vergi Dairesi">
									</div>
								</div>
								<div class="col-6 pl-1">
									<div class="form-group">
										<input type="text" name="vergino" class="form-control" placeholder="Vergi Numarası">
									</div>
								</div>
								<div class="col-12">
									<div class="form-group">
										<input type="text" name="firmaadres" class="form-control" placeholder="Adres*">
									</div>
								</div>
							</div>
							<!-- /row -->
							<div class="row no-gutters">
								<div class="col-6 pr-1">
									<div class="form-group">
										<input type="text" name="firmailce" class="form-control" placeholder="İlçe">
									</div>
								</div>
								<div class="col-6 pl-1">
									<div class="form-group">
										<input type="text" name="firmapostakodu" class="form-control" placeholder="Posta Kodu">
									</div>
								</div>
							</div>
							<!-- /row -->
							...
							<div class="row no-gutters">
								...
								<div class="col-6 pl-1">
									<div class="form-group">
										<input type="text" name="firmatelefon" class="form-control" placeholder="Telefon">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							if($bilgiler!=false)
							{
								...
								<input type="checkbox" name="sozlesme" value="1" checked="">
								<span class="checkmark"></span>
							</label>
								<?php
							}
